...
1. [x] T1 (RED): add failing `functional_spec_3090_*` UI tests for hover highlight marker contracts.
2. [x] T2 (RED): add failing `integration_spec_3090_*` gateway tests for focused-memory highlight mappings.

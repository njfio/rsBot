...
use crate::rpc_capabilities_runtime::{rpc_capabilities_payload, RPC_PROTOCOL_VERSION};

mod dispatch;
mod parsing;
mod transport;

pub use dispatch::dispatch_rpc_frame_impl as dispatch_rpc_frame;
use dispatch::{
    dispatch_rpc_frame_for_serve_impl as dispatch_rpc_frame_for_serve,
    lifecycle_control_audit_record_for_dispatch_impl as lifecycle_control_audit_record_for_dispatch,
};
pub use parsing::parse_rpc_frame_impl as parse_rpc_frame;
pub use parsing::validate_rpc_frame_file_impl as validate_rpc_frame_file;
pub use transport::dispatch_rpc_ndjson_input_impl as dispatch_rpc_ndjson_input;
pub use transport::dispatch_rpc_raw_with_error_envelope_impl as dispatch_rpc_raw_with_error_envelope;
pub use transport::serve_rpc_ndjson_reader_impl as serve_rpc_ndjson_reader;
pub use transport::serve_rpc_ndjson_reader_with_lifecycle_audit_impl as serve_rpc_ndjson_reader_with_lifecycle_audit;

pub const RPC_FRAME_SCHEMA_VERSION: u32 = 1;
...
pub fn rpc_error_contracts() -> &'static [RpcErrorContract] {
...
#[cfg(test)]
pub fn dispatch_rpc_frame_file(path: &std::path::Path) -> Result<RpcResponseFrame> {

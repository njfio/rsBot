...
impl ChannelStore {
    ...
    pub fn parse_channel_ref(raw: &str) -> Result<ChannelRef> {
    ...
    pub fn attachments_index_path(&self) -> PathBuf {
    ...
    pub fn append_log_entry(&self, entry: &ChannelLogEntry) -> Result<()> {
        append_jsonl_line(&self.log_path(), entry)
    }

    pub fn append_context_entry(&self, entry: &ChannelContextEntry) -> Result<()> {
        append_jsonl_line(&self.context_path(), entry)
    }

    pub fn load_log_entries(&self) -> Result<Vec<ChannelLogEntry>> {
        read_jsonl_records(&self.log_path())
    }

    pub fn load_context_entries(&self) -> Result<Vec<ChannelContextEntry>> {
        read_jsonl_records(&self.context_path())
    }

    pub fn load_memory(&self) -> Result<Option<String>> {
    ...
    pub fn sync_context_from_messages(&self, messages: &[Message]) -> Result<usize> {
    ...
    pub fn compact_context(&self, max_records: usize) -> Result<usize> {
    ...
    pub fn inspect(&self) -> Result<ChannelInspectReport> {
    ...
    pub fn repair(&self) -> Result<ChannelRepairReport> {
    ...
    pub fn load_artifact_records(&self) -> Result<Vec<ChannelArtifactRecord>> {
    ...
    pub fn load_artifact_records_tolerant(&self) -> Result<ChannelArtifactLoadReport> {
        let path = self.artifact_index_path();
        if !path.exists() {
    ...
    pub fn append_attachment_record(&self, record: &ChannelAttachmentRecord) -> Result<()> {
        append_jsonl_line(&self.attachments_index_path(), record)
    }

    pub fn load_attachment_records_tolerant(&self) -> Result<ChannelAttachmentLoadReport> {

...
pub struct MultiChannelSendCommandConfig {
    ...
    pub outbound_ssrf_protection_enabled: bool,
    pub outbound_ssrf_allow_http: bool,
    pub outbound_ssrf_allow_private_network: bool,
    pub outbound_max_redirects: usize,
...
fn build_multi_channel_send_outbound_config(
    ...
    MultiChannelOutboundConfig {
        ...
        ssrf_protection_enabled: config.outbound_ssrf_protection_enabled,
        ssrf_allow_http: config.outbound_ssrf_allow_http,
        ssrf_allow_private_network: config.outbound_ssrf_allow_private_network,
        max_redirects: config.outbound_max_redirects,

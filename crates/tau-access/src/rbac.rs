...
pub const RBAC_USAGE: &str = "usage: /rbac <check|whoami> ...";
...
pub fn resolve_local_principal() -> String {
    local_principal(None)
}

pub fn local_principal(actor_override: Option<&str>) -> String {
...
pub fn github_principal(login: &str) -> String {
    format!("github:{}", sanitize_principal_component(login))
}

pub fn slack_principal(user_id: &str) -> String {
    format!("slack:{}", sanitize_principal_component(user_id))
}

pub fn discord_principal(user_id: &str) -> String {
    format!("discord:{}", sanitize_principal_component(user_id))
}

pub fn telegram_principal(user_id: &str) -> String {
    format!("telegram:{}", sanitize_principal_component(user_id))
}

pub fn authorize_command_for_principal(
    principal: &str,
    command_name: &str,
) -> Result<RbacDecision> {
...
pub fn authorize_tool_for_principal_with_policy_path(
    principal: Option<&str>,
    tool_name: &str,
    policy_path: &Path,
) -> Result<RbacDecision> {
...
pub fn authorize_action_for_principal(principal: &str, action: &str) -> Result<RbacDecision> {
    let policy_path = default_rbac_policy_path();
    authorize_action_for_principal_with_policy_path(principal, action, &policy_path)
}

pub fn execute_rbac_command(command_args: &str) -> String {
    let policy_path = default_rbac_policy_path();
    execute_rbac_command_with_path(command_args, &policy_path)
}

pub fn authorize_action_for_principal_with_policy_path(
    principal: &str,
    action: &str,
    policy_path: &Path,
) -> Result<RbacDecision> {
...
pub fn rbac_policy_path_for_state_dir(state_dir: &Path) -> PathBuf {

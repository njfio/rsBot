...
pub(crate) struct MultiChannelChannelPolicy {
    #[serde(default, rename = "dmPolicy")]
    pub(crate) dm_policy: MultiChannelDmPolicy,
    #[serde(default, rename = "allowFrom")]
    pub(crate) allow_from: MultiChannelAllowFrom,
    #[serde(default, rename = "groupPolicy")]
    pub(crate) group_policy: MultiChannelGroupPolicy,
...
pub(crate) struct MultiChannelPolicyFile {
    pub(crate) schema_version: u32,
    #[serde(default, rename = "strictMode")]
    pub(crate) strict_mode: bool,
    #[serde(default, rename = "defaultPolicy")]
    pub(crate) default_policy: MultiChannelChannelPolicy,
    #[serde(default)]
    pub(crate) channels: BTreeMap<String, MultiChannelChannelPolicy>,
}
...
#[serde(rename_all = "snake_case")]
pub(crate) enum MultiChannelConversationKind {
    Dm,
    Group,
}
...
pub(crate) enum MultiChannelPolicyDecision {
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(crate) struct MultiChannelPolicyEvaluation {
    pub(crate) policy_channel: String,
    pub(crate) matched_policy_key: String,
    pub(crate) policy: MultiChannelChannelPolicy,
    pub(crate) conversation_kind: MultiChannelConversationKind,
    pub(crate) mention_present: bool,
    pub(crate) decision: MultiChannelPolicyDecision,
}

pub(crate) fn channel_policy_path_for_state_dir(state_dir: &Path) -> PathBuf {
...
pub(crate) fn load_multi_channel_policy_for_state_dir(
    state_dir: &Path,
) -> Result<MultiChannelPolicyFile> {
...
pub(crate) fn load_multi_channel_policy_file(path: &Path) -> Result<MultiChannelPolicyFile> {
    if !path.exists() {
...
pub(crate) fn evaluate_multi_channel_channel_policy(
...
pub(crate) fn collect_open_dm_risk_channels(policy_file: &MultiChannelPolicyFile) -> Vec<String> {

...
pub(crate) const BROWSER_AUTOMATION_CONTRACT_SCHEMA_VERSION: u32 = 1;

pub(crate) const BROWSER_AUTOMATION_ERROR_INVALID_OPERATION: &str =
    "browser_automation_invalid_operation";
pub(crate) const BROWSER_AUTOMATION_ERROR_INVALID_ACTION: &str =
    "browser_automation_invalid_action";
pub(crate) const BROWSER_AUTOMATION_ERROR_INVALID_URL: &str = "browser_automation_invalid_url";
pub(crate) const BROWSER_AUTOMATION_ERROR_INVALID_SELECTOR: &str =
    "browser_automation_invalid_selector";
pub(crate) const BROWSER_AUTOMATION_ERROR_INVALID_INPUT: &str = "browser_automation_invalid_input";
pub(crate) const BROWSER_AUTOMATION_ERROR_UNSAFE_OPERATION: &str =
    "browser_automation_unsafe_operation";
pub(crate) const BROWSER_AUTOMATION_ERROR_TIMEOUT: &str = "browser_automation_timeout";
pub(crate) const BROWSER_AUTOMATION_ERROR_BACKEND_UNAVAILABLE: &str =
    "browser_automation_backend_unavailable";
pub(crate) const BROWSER_AUTOMATION_ERROR_ACTION_LIMIT_EXCEEDED: &str =
...
pub(crate) enum BrowserAutomationOutcomeKind {
    Success,
    MalformedInput,
    RetryableFailure,
}
...
pub(crate) struct BrowserAutomationCaseExpectation {
    pub(crate) outcome: BrowserAutomationOutcomeKind,
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct BrowserAutomationContractCase {
    ...
    pub(crate) action_repeat_count: usize,
    #[serde(default = "default_timeout_ms")]
    pub(crate) timeout_ms: u64,
    #[serde(default)]
    pub(crate) unsafe_operation: bool,
    #[serde(default)]
    pub(crate) simulate_retryable_failure: bool,
    #[serde(default)]
    pub(crate) simulate_timeout: bool,
    pub(crate) expected: BrowserAutomationCaseExpectation,
}

#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct BrowserAutomationContractFixture {
    pub(crate) schema_version: u32,
    pub(crate) name: String,
    #[serde(default)]
    pub(crate) description: String,
    pub(crate) cases: Vec<BrowserAutomationContractCase>,
}

#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct BrowserAutomationContractCapabilities {
    pub(crate) schema_version: u32,
    pub(crate) supported_outcomes: BTreeSet<BrowserAutomationOutcomeKind>,
    pub(crate) supported_error_codes: BTreeSet<String>,
    pub(crate) supported_operations: BTreeSet<String>,
    pub(crate) supported_actions: BTreeSet<String>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq)]
pub(crate) enum BrowserAutomationReplayStep {
    Success,
    MalformedInput,
    RetryableFailure,
}
...
#[derive(Debug, Clone, PartialEq, Eq)]
pub(crate) struct BrowserAutomationReplayResult {
    pub(crate) step: BrowserAutomationReplayStep,
    pub(crate) status_code: u16,
...
pub(crate) struct BrowserAutomationReplaySummary {
...
#[cfg(test)]
pub(crate) trait BrowserAutomationContractDriver {
    fn apply_case(
        &mut self,
...
pub(crate) fn parse_browser_automation_contract_fixture(
    raw: &str,
...
pub(crate) fn load_browser_automation_contract_fixture(
    path: &Path,
) -> Result<BrowserAutomationContractFixture> {
...
pub(crate) fn browser_automation_contract_capabilities() -> BrowserAutomationContractCapabilities {
...
pub(crate) fn validate_browser_automation_contract_compatibility(
...
pub(crate) fn validate_browser_automation_contract_fixture(
    fixture: &BrowserAutomationContractFixture,
) -> Result<()> {
...
pub(crate) fn evaluate_browser_automation_case(
    case: &BrowserAutomationContractCase,
...
pub(crate) fn assert_browser_automation_result_matches_expectation(
    case: &BrowserAutomationContractCase,
    result: &BrowserAutomationReplayResult,
) -> Result<()> {
...
#[cfg(test)]
pub(crate) fn run_browser_automation_contract_replay<D: BrowserAutomationContractDriver>(
    fixture: &BrowserAutomationContractFixture,
    driver: &mut D,

...
pub(crate) fn test_cli() -> Cli {
    Cli {
        ...
        provider_rate_limit_capacity: 0,
        provider_rate_limit_refill_per_second: 0,
        provider_rate_limit_max_wait_ms: 0,
        turn_timeout_ms: 0,
        json_events: false,
        stream_output: true,
        stream_delay_ms: 0,
        ...
        gateway_openresponses_auth_token_id: None,
        gateway_openresponses_auth_password: None,
        gateway_openresponses_auth_password_id: None,

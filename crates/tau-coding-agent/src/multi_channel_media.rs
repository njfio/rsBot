...
pub(crate) struct MultiChannelMediaUnderstandingConfig {
    pub(crate) enabled: bool,
    pub(crate) max_attachments_per_event: usize,
...
pub(crate) enum MediaUnderstandingDecision {
    Processed,
    Skipped,
    Failed,
}
...
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq)]
pub(crate) struct MediaUnderstandingOutcome {
    pub(crate) attachment_id: String,
    pub(crate) decision: MediaUnderstandingDecision,
...
pub(crate) struct MediaUnderstandingReport {
    pub(crate) processed: usize,
    pub(crate) skipped: usize,
    pub(crate) failed: usize,
    pub(crate) truncated_summaries: usize,
    pub(crate) outcomes: Vec<MediaUnderstandingOutcome>,
    pub(crate) reason_code_counts: BTreeMap<String, usize>,
}
...
pub(crate) struct MediaUnderstandingProviderError {
    pub(crate) reason_code: String,
...
pub(crate) trait MediaUnderstandingProvider {
    fn describe_image(
        &self,
...
pub(crate) struct DeterministicMediaUnderstandingProvider;
...
pub(crate) fn process_media_attachments(
...
pub(crate) fn process_media_attachments_with_provider<P: MediaUnderstandingProvider>(
    event: &MultiChannelInboundEvent,
    config: &MultiChannelMediaUnderstandingConfig,
    provider: &P,
) -> MediaUnderstandingReport {
...
pub(crate) fn render_media_prompt_context(report: &MediaUnderstandingReport) -> Option<String> {

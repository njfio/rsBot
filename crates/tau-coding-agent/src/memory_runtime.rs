...
#[derive(Debug, Clone)]
pub(crate) struct MemoryRuntimeConfig {
...
pub(crate) struct MemoryRuntimeSummary {
    ...
    pub(crate) upserted_entries: usize,
}
...
pub(crate) async fn run_memory_contract_runner(config: MemoryRuntimeConfig) -> Result<()> {

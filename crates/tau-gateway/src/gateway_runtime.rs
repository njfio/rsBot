...
pub struct GatewayRuntimeConfig {
    ...
    pub guardrail_failure_streak_threshold: usize,
    pub guardrail_retryable_failures_threshold: usize,
}
...
pub struct GatewayServiceStatusReport {
    ...
    pub rollout_reason_code: String,
    pub guardrail_gate: String,
    pub guardrail_reason_code: String,
    pub service_startup_attempts: u64,
    pub service_startup_failure_streak: usize,
    pub service_last_startup_error: String,
    pub service_last_started_unix_ms: u64,
    pub service_last_stopped_unix_ms: u64,
    pub service_last_transition_unix_ms: u64,
    pub service_last_stop_reason: String,
...
mod tests {
    ...
    use tau_runtime::{ChannelStore, TransportHealthSnapshot, TransportHealthState};
